                    ...
                    <div class="row align-items-center">
                        <div class="col-md-6">
                            <ul class="header-info-left">
                                ...
                                <li><span><i class="fa fa-phone" aria-hidden="true"></i> </span>+90 534 078 13 62</li>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6">
                            <div class="footer-widget widget_text">
                                <a href="index.html"><img src={{asset("assets/images/logos/logo-footer.svg")}} style="width: 250px;"></a>
