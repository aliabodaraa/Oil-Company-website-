    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8">
                ...
                <p class="about-description"> We are a leading Oil Field service provider with lots of experience and partners in the industry. We aim to deliver industry standard services to meet all the needs of the market. We do not compromise in quality of service. Our goal is to be a leading provider and to contribute to the local community. Our aim is to contribute to the Tturkish economy by providing top quality services, training and opportunities</p>
                <a href="about.html" class="read-more">Read more <span><i class="fa fa-long-arrow-right" aria-hidden="true"></i></span></a>
            </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col text-center wow fadeInUp">
                <a href="services.html" class="btn uh-btn-active">View all Services</a>
            </div>
        </div>
    </div>
</section>
